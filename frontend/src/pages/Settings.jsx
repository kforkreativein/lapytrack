...
import { Lock, LogOut, ShieldCheck, Cpu, ChevronRight, Mail, Eye, EyeOff } from "lucide-react";

export default function Settings() {
  const { user, changePin, setEmailPassword, logout, lockNow, formatApiErrorDetail } = useAuth();
